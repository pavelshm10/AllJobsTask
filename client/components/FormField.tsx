...
export default function FormField({
  ...
  const fieldStyles = `w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 ${
    error
      ...
      return (
        <div className="relative">
          ...
          <input
            ...
            className={`${fieldStyles} pl-8 pr-4 ${disabledStyles}`}
            disabled={disabled}
          />
        </div>
      );
